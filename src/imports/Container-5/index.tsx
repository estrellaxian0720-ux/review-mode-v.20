import svgPaths from "./svg-aauflo9g2o";
...
function Button4() {
  return (
    <div className="absolute bg-[#fdea3b] h-[54px] left-[171.44px] rounded-[16px] top-[417.72px] w-[284px]" data-name="button">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Inter:Bold',sans-serif] font-bold h-[24px] leading-[24px] left-[154px] not-italic text-[#1c1c1c] text-[16px] text-center top-[15px] tracking-[-0.4688px] w-[208px]">Create a New Study Plan</p>
    </div>
  );
}
  ...
  return (
    <div className="h-[500px] relative shrink-0 w-[620px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        ...
        <Container8 />
        <H1 />
        <p className="[word-break:break-word] absolute font-['Pacifico:Regular',sans-serif] h-[47px] leading-[0] left-[4.44px] not-italic opacity-50 text-[0px] text-black top-[356.72px] w-[579px]">
          <span className="font-['PingFang_SC:Regular',sans-serif] leading-[normal] text-[14px]">适合</span>
          <span className="font-['PingFang_SC:Semibold',sans-serif] leading-[normal] text-[14px]">知识点/概念型资料</span>
          <span className="font-['PingFang_SC:Regular',sans-serif] leading-[normal] text-[14px]">，辅助消化教材笔记、章节总结、资格证备考</span>
        </p>
        <p className="[word-break:break-word] absolute font-['PingFang_SC:Regular',sans-serif] h-[46px] leading-[0] left-[4.44px] not-italic opacity-50 text-[0px] text-black top-[380.72px] w-[376px]">
          <span className="font-['PingFang_SC:Semibold',sans-serif] leading-[normal] text-[14px]">语言类资料</span>
          <span className="leading-[normal] text-[14px]">暂不适用；英语学习模式即将上线。</span>
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div className="h-[11.997px] relative shrink-0 w-[10px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10 11.9965">
        <g clipPath="url(#clip0_14276_248)" id="Icon">
...
function Icon1() {
  return (
    <div className="h-[11.997px] relative shrink-0 w-[10px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10 11.9965">
        <g clipPath="url(#clip0_14276_242)" id="Icon">
...
function Paragraph() {
  return <div className="h-[26px] relative shrink-0 w-[171.997px]" data-name="Paragraph" />;
}
...
function Container36() {
  return <div className="h-[19px] relative shrink-0 w-[176.675px]" data-name="Container" />;
}
  ...
  return (
    <div className="absolute h-[254.333px] left-[162px] max-w-[720.0000610351562px] top-[118.44px] w-[720px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        ...
        <Container37 />
        <Container38 />
        <p className="[word-break:break-word] absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[13px] not-italic text-[16px] text-black top-[230px] whitespace-nowrap">Feeling overwhelmed?</p>
        <p className="[word-break:break-word] absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[246px] not-italic text-[#166534] text-[20px] top-[227px] whitespace-nowrap">AI builds your study plan</p>
        <p className="[word-break:break-word] absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[527px] not-italic text-[16px] text-black top-[227px] whitespace-nowrap">Today’s task is ready</p>
      </div>
    </div>
  );
}
...
function Frame() {
  return (
    <div className="absolute left-[160px] size-[30px] top-[416.44px]" data-name="Frame">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 30 30">
        <g id="Frame">
          <path d={svgPaths.p31bb0080} fill="var(--fill-0, #E22D2D)" id="Vector" />
          <path d={svgPaths.p24850c00} fill="var(--fill-0, #AF3737)" id="Vector_2" />
        </g>
      </svg>
    </div>
  );
...
function Frame1() {
  return (
    <div className="absolute left-[161px] size-[30px] top-[390.44px]" data-name="Frame">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 30 30">
        <g id="Frame">
          <path d={svgPaths.p2fee4d80} fill="var(--fill-0, #AECD42)" id="Vector" />
          <path d={svgPaths.p3dbebd00} fill="var(--fill-0, #809626)" id="Vector_2" />
        </g>
      </svg>
    </div>
  );
