import svgPaths from "./svg-cccj7ppyyr";

function Heading() {
  return (
    <div className="h-[28.003px] relative shrink-0 w-[68.941px]" data-name="Heading 2">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold','Noto_Sans_JP:Bold','Noto_Sans_SC:Bold',sans-serif] font-semibold leading-[28px] left-0 not-italic text-[#101828] text-[18px] top-[0.33px] tracking-[-0.4395px] whitespace-nowrap">上传完成</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[15.998px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9983 15.9983">
        <g clipPath="url(#clip0_15226_1801)" id="Icon">
          <path d={svgPaths.p2adbb400} id="Vector" stroke="var(--stroke-0, #00A63E)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33319" />
          <path d={svgPaths.p29206400} id="Vector_2" stroke="var(--stroke-0, #00A63E)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33319" />
        </g>
        <defs>
          <clipPath id="clip0_15226_1801">
...
function Text() {
  return (
    <div className="h-[20px] relative shrink-0 w-[92.622px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular','Noto_Sans_JP:Regular','Noto_Sans_SC:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#4a5565] text-[14px] top-[0.67px] tracking-[-0.1504px] whitespace-nowrap">2 个文件已上传</p>
      </div>
    </div>
  );
}
...
function Container2() {
  return (
    <div className="h-[20px] relative shrink-0 w-[151px]" data-name="Container">
...
function Container3() {
  return (
    <div className="h-[213px] relative shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex flex-col items-start pt-[20px] px-[23.993px] relative size-full">
        <Container4 />
      </div>
    </div>
  );
