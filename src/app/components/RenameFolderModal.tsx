...
export function RenameFolderModal({ currentName, onConfirm, onCancel }: RenameFolderModalProps) {
      ...
      <div className="bg-white rounded-2xl w-[400px] p-6 shadow-xl">
        <div className="flex items-start justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-[18px] font-bold text-[#111827]">Rename Folder</h2>
              <p className="text-[13px] text-[#6B7280]">Update folder name</p>
            </div>
          </div>
          <button
            onClick={onCancel}
